        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-secondary navbar-dark">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="widget.html" class="nav-item nav-link"><i class="fa fa-th me-2"></i>App Settings</a>
                    <a href="form.html" class="nav-item nav-link"><i class="fa fa-keyboard me-2"></i>Advertisement</a>
        ...
        <div class="content">
            ...
            <nav class="navbar navbar-expand bg-secondary navbar-dark sticky-top px-4 py-0">
                ...
                <div class="navbar-nav align-items-center ms-auto">
                    <div class="nav-item dropdown">
                    <a href="/view" class="dropdown-item">Home</a>     
                    </div>
                    <div class="nav-item dropdown">
                    ...
                    <div class="table-responsive">
                        <table class="table text-start align-middle table-bordered table-hover mb-0">
                            ...
                            <tbody>
                              ...
                              <a href="{{ url('/categorys/delete', $q->id) }}" class="btn btn-danger btn-sm" >Delete</a></td>
                              </tr>
                          @endforeach
                            </tbody>
                        </table>
