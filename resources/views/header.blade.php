        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-secondary navbar-dark">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="{{ url('/addappsetting/edit', $data->id) }}" class="nav-item nav-link"><i class="fa fa-th me-2"></i>App Settings</a>
                    <a href="/ads" class="nav-item nav-link"><i class="fa fa-keyboard me-2"></i>Advertisement</a>
