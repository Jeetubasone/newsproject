...
<div class="container-fluid bg-dark pt-5 px-sm-3 px-md-5 mt-5">
    <div class="row py-4">
        <div class="col-lg-3 col-md-6 mb-5">
            ...
            <p class="font-weight-medium"><i class="fa fa-map-marker-alt mr-2"></i>468 , Pacific Business Center, Bhopal</p>
            <p class="font-weight-medium"><i class="fa fa-phone-alt mr-2"></i>+91 345 67890</p>
            <p class="font-weight-medium"><i class="fa fa-envelope mr-2"></i>info@newstoday.com</p>
...
<div class="container-fluid py-4 px-sm-3 px-md-5" style="background: #111111;">
    <p class="m-0 text-center">&copy; <a href="#">NewsToday</a>. All Rights Reserved.
