                ...
                <div class="col-12">
                    <div class="d-flex justify-content-between">
                        ...
                        <div class="owl-carousel tranding-carousel position-relative d-inline-flex align-items-center bg-white border border-left-0" style="width: calc(100% - 180px); padding-right: 100px;">
                            ...
                            <div class="text-truncate"><a class="text-secondary text-uppercase font-weight-semi-bold" href="{{ url('/singlenews', $q->id) }}" id="id" name="id" value={{$q->id}}">{{$q->title}}</a></div>
                            @endforeach
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-8">
                    ...
                    <div class="position-relative mb-3">
                        ...
                        <div class="bg-white border border-top-0 p-4">
                            ...
                            <p>{{$q->content}}</p>
                            <p>{{$q->content}}</p>
                            <h3 class="text-uppercase font-weight-bold mb-3">{{$q->title}}</h3>
                            <img class="img-fluid w-50 float-left mr-4 mb-2" src="{{$q->image}}">
                            <p>{{$q->content}}</p>
                            <h5 class="text-uppercase font-weight-bold mb-3">{{$q->title}}</h5>
